...
public class InsertionSortEx2 {
    ...
    /**
     * Gera um array de inteiros em ordem decrescente de (size-1) até 0.
     *
     * @param size Tamanho do array
     * @return array decrescente de inteiros
     */
    ...
    public static void main(String[] args) {
        ...
        for (int n : sizes) {
            ...
            // Mede tempo para o array decrescente
            long timeDescending = measureInsertionSortTime(descendingArray);

            System.out.printf("%-10d %-20d %-20d\n", n, timeSorted, timeDescending);
        }
    }
}
